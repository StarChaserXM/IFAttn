...
def do_train(opts):
    ...
    # config_folder = "D:\program_jiang\Pro\CodeTransformer\BCSA\TikNib\config\gnu_type"
        ...
        for trial_idx, (train_func_keys, test_func_keys) in enumerate(kf.split(func_keys)):
            ...
            for epoch in range(opts.epoch):
                ...
                for i,data in enumerate(data_loader):
                    ...
                    optimizer.step()
                    # src_all.extend(src.detach().numpy())
                    # dst_all.extend(dst.detach().numpy())
                ...
                # topk = calc_topK(src_all, dst_all, lable_all, k)
            ...
            # print(src_all[0].shape,src_all[0])
